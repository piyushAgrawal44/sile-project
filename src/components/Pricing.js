        ...
        <>
            <div className='bg-white py-10 sm:py-16 px-5 sm:px-10'>
                ...
                <div className="mt-8 flex justify-evenly flex-wrap md:flex-nowrap md:space-x-4 ">
                    <div className="min-w-[240px] md:w-[400px] max-w-[500px] md:translate-x-[30px] bg-[#EFF0FF] ease-linear duration-200 box-shadow-grey-10 py-5 px-10 md:my-10 rounded-3xl md:rounded-[45px] text-start">
                        <div className='py-8'>
                    ...
                    <div className="min-w-[240px] md:w-[400px] max-w-[500px] z-10 bg-white ease-linear duration-200 box-shadow-grey-10 py-5 px-10 md:my-10 rounded-3xl md:rounded-[45px] text-start md:scale-y-105">
                        <div className='py-8'>
            ...
            <div className="mt-16 sm:px-16">
                <div className="bg-[#2B1C50] py-16 px-5 sm:px-10 text-start sm:text-center sm:rounded-3xl md:rounded-[45px] text-white">
            ...
            <div className="our_customers ">
                <h3 className='font-bold text-xl sm:text-2xl md:text-[35px] md:leading-10 text-center px-5 sm:px-10 my-10 sm:w-[80%] m-auto'>
