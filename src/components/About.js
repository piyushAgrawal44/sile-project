  ...
  return (
    <>
      <div className='bg-[#2B1C50]'>
        <div className="banner bg-[#140B2A] relative pt-8 sm:pt-0 text-start sm:text-center overflow-y-hidden">
          <div className='px-5 sm:px-16 py-5 sm:pt-16 lg:absolute w-[100%]'>
            <h1 className=' text-violet-50 font-bold text-[35px]  md:text-[40px] lg:text-[55px] mb-4'>Bring video messaging to the world</h1>
        ...
        <div className='banner bg-[#140B2A] pt-16'>
          ...
          <div className="companies_slider h-[150px]">

          </div>

          <div className=' bg-[#2B1C50] py-16 w-[98%] sm:w-[90%] mx-auto my-10 rounded-r-[30px] rounded-bl-[30px]'>
      ...
      <div className='bg-white py-10 sm:py-16 px-5 sm:px-10'>
        <h1 className='font-bold text-2xl sm:text-3xl md:text-4xl text-center'>News from <span className='text-blue-700 font-mono font-bold'>SILE</span></h1>

        <div className="mt-16 px-5 sm:px-10 flex justify-evenly flex-wrap md:flex-nowrap md:space-x-5 ">
          <div className="min-w-[200px] mb-6">
            <div className=" bg-sub-color1 ease-linear duration-200 hover:bg-violet-50 hover:shadow-xl hover:shadow-slate-400 py-5 px-5 md:px-10 md:my-10 rounded-r-2xl rounded-bl-2xl md:rounded-r-[40px] md:rounded-bl-[40px] text-start">
