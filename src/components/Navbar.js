            ...
            <div className={`h-[350px] overflow-y-auto bg-white pt-5 w-[100%] ease-in duration-300 fixed ${menu === 1 ? 'left-[100%]' : 'left-[0%]'}  z-50`} id='sideMenu'>
                <div className="links ">
                    <div className='mb-2 px-4 py-5 border-b-2'>
                        <Link onClick={showMenu} className="font-medium text-lg sm:text-2xl hover:underline " to="/about">About</Link>
                    </div>
                    <div className='mb-2 px-4 py-5 border-b-2'>
                        <Link onClick={showMenu} className="font-medium text-lg sm:text-2xl hover:underline" to="/">Use Cases</Link>
                    </div>
                    <div className='mb-2 px-4 py-5 border-b-2'>
                        <Link onClick={showMenu} className="font-medium text-lg sm:text-2xl hover:underline " to="/">Features</Link>
                    </div>
                    <div className='mb-2 px-4 py-5 border-b-2'>
                        <Link onClick={showMenu} className="font-medium text-lg sm:text-2xl hover:underline" to="/">Experience</Link>
                    </div>
                    <div className='mb-2 px-4 py-5 border-b-2'>
                        ...
                        <div className=' py-3 px-2 services hidden' id='services'>
                            <div className='flex flex-col'>
                                <Link onClick={showMenu} to="/new" className='mb-2 font-medium text-lg hover:underline'><i className="bi bi-card-list"></i> Listing our offering</Link>
                                <Link onClick={showMenu} to="/new" className='mb-2 font-medium text-lg hover:underline'><i className="bi bi-card-list"></i> Previous Project</Link>
                            </div>
                        </div>
                    </div>
                    <div className='mb-2 px-4 py-5 border-b-2'>
                        <Link onClick={showMenu} className="font-medium text-lg sm:text-2xl hover:underline" to="/pricing">Pricing</Link>
                    </div>
                    ...
                    <div className='mb-2 px-4 py-5 border-b-2'>
                        ...
                        <div className=' py-3 px-2 resources hidden' id='resources'>
                            <div className='flex flex-col'>
                                <Link onClick={showMenu} to="/new" className='mb-2 font-medium text-lg hover:underline'><i className="bi bi-bookmarks"></i> Bolg</Link>
                                <Link onClick={showMenu} to="/experts-collective" className='mb-2 font-medium text-lg hover:underline'><i className="bi bi-card-list"></i> Expert Collective</Link>
                                <Link onClick={showMenu} to="/community" className='mb-2 font-medium text-lg hover:underline'><i className="bi bi-people"></i> Community</Link>
                            </div>
                        </div>
                    </div>

                    <div className='md-2 sm:mb-0 px-4 py-5  border-b-2'>
                        <Link onClick={showMenu} className="font-medium text-lg sm:text-2xl hover:underline" to="/">Sign in Try SILE for Free</Link>
                    </div>
