    ...
    return (
        <>
            <div className='relative p-0 overflow-hidden w-[100%] h-[340px] '>
                <div className="card card1 absolute  duration-300 bg-[#E3F3FF] p-5 sm:px-10 sm:py-10 w-[90%] h-[340px] left-[-88%] rounded-3xl" id='card1'>
                <div className="text-center img h-[50px] mb-10">
                        <img src={img1} className='max-w-[100px] m-auto' alt="company" />
                    </div>
                    <div className='h-[120px] overflow-auto scrollbar-hidden text-justify sm:w-[90%] m-auto'>
                        <span className='text-sm sm:text-xl font-medium text-[#2B1C50]'>"1nd Lorem ipsum dolor sit amet consectetur adipisicing elit. Facere voluptatem sit quia nesciunt ? Reiciendis, impedit Reiciendis, impedit. Reiciendis, impedit Reiciendis, impedit."</span>
                    </div>
                    <div className='h-[50px] flex items-center justify-center space-x-2'>
                        <div>
                            <img src={img2} className='max-w-[70px] m-auto' alt="customer" />
                        </div>
                        <div className="flex flex-col space-y-1">
                            <span className='font-medium text-lg text-[#2B1C50]'>Kieran Flanagan</span>
                            <span className='font-light text-sm text-[#2B1C50]'>VP of Marketing, HubSpot</span>
                        </div>
                    </div>
                </div>

                <div className="card active card2 absolute  duration-300 bg-[#EFF0FF] p-5 sm:px-10 sm:py-10 w-[90%] h-[340px] left-[5%] rounded-3xl" id='card2'>
                    <div className="text-center img h-[50px] mb-10">
                        <img src={img1} className='max-w-[100px] m-auto' alt="company" />
                    </div>
                    <div className='h-[120px] overflow-auto scrollbar-hidden text-justify sm:w-[90%] m-auto'>
                ...
                <div className="card card3 absolute  duration-300 bg-[#F8EDFB] p-5 sm:px-10 sm:py-10 w-[90%] h-[340px] left-[98%] rounded-3xl" id='card3'>
                <div className="text-center img h-[50px] mb-10">
                        <img src={img1} className='max-w-[100px] m-auto' alt="company" />
                    </div>
                    <div className='h-[120px] overflow-auto scrollbar-hidden text-justify sm:w-[90%] m-auto'>
                        <span className='text-sm sm:text-xl font-medium text-[#2B1C50]'>"3nd Lorem ipsum dolor sit amet consectetur adipisicing elit. Facere voluptatem sit quia nesciunt ? Reiciendis, impedit Reiciendis, impedit. Reiciendis, impedit Reiciendis, impedit."</span>
                    </div>
                    <div className='h-[50px] flex items-center justify-center space-x-2'>
                        <div>
                            <img src={img2} className='max-w-[70px] m-auto' alt="customer" />
